...
<section class="pt-10 overflow-hidden bg-gray-50 md:pt-0 sm:pt-16 2xl:pt-16">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl mb-10">
        <div class="grid items-center grid-cols-1 md:grid-cols-2 mt-24">
            <div>
                <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Hey, Você Sabe quem somos? </h2>
                <p class="max-w-lg mt-3 text-xl leading-relaxed text-gray-600 md:mt-8">Não existe nada pior do que a frustração de trabalhar em algo que não ama, por isso nós vamos te ajudar a descobrir exatamente o que combina com você. Agora queremos ajudar você a escolher a profissão certa e ter uma vida mais feliz.</p>

                <p class="max-w-lg mt-3 text-xl leading-relaxed text-gray-600 md:mt-8">Acreditamos na democratização desse processo, tornando-o acessível a todos, e colocamos à disposição dos nossos clientes uma abordagem personalizada e eficiente, baseada em anos de experiência e conhecimento especializado.</p>
        ...
        <div className="grid items-center mt-8 mb-60 ">
                ...
                <p class="mt-4 text-xl text-gray-600 md:mt-8">
                    <span class="relative inline-block">
                        ...
                        <span class="relative"> Está pronto para o teste? </span>
                    </span>
                    <br class="block sm:hidden" />Faço agora <a href="#" title="" class="transition-all duration-200 text-sky-500 hover:text-sky-600 hover:underline">Teste vocacional</a>
                </p>
